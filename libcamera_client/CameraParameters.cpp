...
const char CameraParameters::EFFECT_BW[] = "bw";
const char CameraParameters::EFFECT_BLUISH[] = "bluish";
const char CameraParameters::EFFECT_REDDISH[] = "reddish";
const char CameraParameters::EFFECT_GREENISH[] = "greenish";
